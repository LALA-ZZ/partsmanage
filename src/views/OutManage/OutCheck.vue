    ...
    <el-card shadow="hover">
      ...
      <el-form :inline="true"
        ...
        <el-button type="primary"
                   icon="el-icon-search"
                   @click="getApplyList">快速搜索</el-button>
      ...
      <el-table :data="applyList"
        ...
        <el-table-column label="操作"
          ...
          <template slot-scope="scope">
            <el-button size="mini"
                       type="warning"
                       @click="showApprovalDialog(scope.row.id)">审核</el-button>
          </template>
        </el-table-column>
      </el-table>
    ...
    <el-dialog title="申请单审核"
      ...
      <el-card shadow="hover">
        ...
        <el-form :model="approvalForm"
          ...
          <el-form-item label="申请单编号"
                        ...
                        :disabled="true">
            <el-input v-model="approvalForm.id"
          ...
          <el-form-item label="审核状态"
                        prop="status"
                        :label-width="formLabelWidth">
            <el-select v-model="approvalForm.status"
                       placeholder="状态">
              <el-option v-for="item in options"
                         :key="item.value"
                         :label="item.label"
          ...
          <el-form-item label="审批人"
                        prop="approvalPerson"
                        :label-width="formLabelWidth">
            <el-input v-model="approvalForm.approvalPerson"
                      autocomplete="off"></el-input>
          </el-form-item>
          <el-form-item label="审批意见"
                        prop="approvalOpinion"
                        :label-width="formLabelWidth">
            <el-input v-model="approvalForm.approvalOpinion"
                      autocomplete="off"></el-input>
          </el-form-item>
        </el-form>
      </el-card>
      ...
      <el-card shadow="hover"
        ...
        <span slot="footer"
          ...
          <el-button type="primary"
                     @click="confirmApproval">发布审核</el-button>
        </span>
      </el-card>
