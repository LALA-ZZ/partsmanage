...
export default {
  ...
  created () {
    ...
    // console.log(this.queryParams.staffId)
  ...
  methods: {
    ...
    getallotApplyList () {
      ...
      this.$axios.post('/api/ch10/applyParts/selectOfflineApply', data, { headers: { 'Content-Type': 'application/x-www-form-urlencoded' } }).then(res => {
        console.log(res.data)

        if (res.data.status !== 'success') {
          return this.$message.error('获取数据失败！')
        }
        this.allotApplyList = res.data.offlineApplyList
