        ...
        <el-row :gutter="40">
          <el-col :span="8">
            <el-form-item label="制单人"
                          prop="documentMaker">
              <el-input v-model="entryForm.documentMaker"
                        placeholder="制单人"
                        clearable></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="供货单位"
                          prop="supplier">
              <el-input v-model="entryForm.supplier"
                        placeholder="供货单位"
                        clearable></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="入库方式"
                          prop="applystyle">
              <el-select v-model="entryForm.applystyle"
                         placeholder="请选择">
        ...
        <el-row :gutter="40">
          <el-col :span="8">
            <el-form-item label="入库仓库"
                          prop="entryWare">
              <el-input v-model="entryForm.entryWare"
                        placeholder="入库仓库"
                        clearable></el-input>
            </el-form-item>
          </el-col>
